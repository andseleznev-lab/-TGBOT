...
- [x] **Исправление таймаутов и обработки ошибок** (31.01.2026)
...
| 9 | Короткий таймаут запросов (15 сек) | `api.js` | ✅ Увеличен до 30 сек |
| 10 | Отсутствие проверки выбора услуги | `app.js` | ✅ Добавлена проверка |
| 11 | Плохие сообщения об ошибках | `app.js` | ✅ Улучшены |
| 12 | Устаревший метод substr() | `api.js` | ✅ Заменен на substring() |
...
1. **Таймауты API** - ~~иногда запросы к Make.com занимают >15 секунд~~ ✅ ИСПРАВЛЕНО
